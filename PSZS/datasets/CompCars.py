...
class CompCars(CustomDataset):
    ...
    def __init__(self, 
        ...
        # e.g., format is [classIndexMake][sub_sep][classIndexModel]
        # if the main label is the model then main_class_idx=1
        # if the main label is the make then main_class_idx=0
