...
from PSZS.Optimizer.Base_Single import Base_Single
from PSZS.Models import CustomModel
from PSZS.Utils.io.logger import Logger

class ERM_Single(Base_Single):
    """
    For ERM this is basically just a wrapper around the Base_Single class
    ...
    def _forward_train(self, data: torch.Tensor
