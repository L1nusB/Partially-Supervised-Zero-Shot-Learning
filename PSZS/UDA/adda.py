...
def main(args: argparse.Namespace):
    ...
    for epoch in range(args.epochs):
        ...
        # train for one epoch
        train_domain_accs, train_loss_trans = train(train_source_iter, train_target_iter, source_classifier, target_classifier, domain_adv,
        ...
        metrics.update([('train_domain_accs', train_domain_accs),
                        ('train_loss_trans', train_loss_trans), 
                        ('eval_acc1', acc1),
                        ('best_acc1', best_acc1)])
...
def train(train_source_iter: ForeverDataIterator, train_target_iter: ForeverDataIterator,
    ...
    return domain_accs.avg, losses_transfer.avg
