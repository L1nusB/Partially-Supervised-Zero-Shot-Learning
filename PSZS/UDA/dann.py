...
def main(args: argparse.Namespace):
    ...
    for epoch in range(args.epochs):
        ...
        # train for one epoch
        train_cls_acc1, train_domain_acc1 = train(train_source_iter, train_target_iter, classifier, domain_adv, optimizer,
        ...
        metrics.update([('train_cls_acc1', train_cls_acc1),
                        ('train_domain_acc1', train_domain_acc1), 
                        ('eval_acc1', acc1),
                        ('best_acc1', best_acc1)])
...
def train(train_source_iter: ForeverDataIterator, train_target_iter: ForeverDataIterator,
    ...
    return cls_accs.avg, domain_accs.avg
