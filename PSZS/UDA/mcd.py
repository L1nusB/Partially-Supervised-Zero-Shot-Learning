...
def main(args: argparse.Namespace):
    ...
    for epoch in range(args.epochs):
        # train for one epoch
        train_cls_accs, train_losses, train_trans_losses = train(train_source_iter, train_target_iter, G, F1, F2, optimizer_g, optimizer_f, epoch, args)
        ...
        if max(results) > best_acc1 or osp.exists(logger.get_checkpoint_path('best'))==False:
    ...
    metrics = OrderedDict()
    metrics.update([('test_acc1', max(results))])
...
def train(train_source_iter: ForeverDataIterator, train_target_iter: ForeverDataIterator,
    ...
    return cls_accs.avg, losses.avg, trans_losses.avg
