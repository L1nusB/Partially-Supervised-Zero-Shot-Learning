...
from .BiLin_Domain_Adv_Model import BiLin_Domain_Adv_Model
...
from .DASA_Model import DASA_Model
...
METHOD_MODEL_MAP : Dict[str, CustomModel] = {
    ...
    'dasa': DASA_Model,
    'ccsa': CustomModel,
    'bilinear': BiLin_Domain_Adv_Model,
    'val': CustomModel,
}
...
__all__ = ['get_model_names', 'build_model', 'load_backbone', 
           ...
           'JAN_Model', 'ADDA_Model', 'MCD_Model', 'PAN_Model', 'DASA_Model',
           'BiLin_Domain_Adv_Model']
